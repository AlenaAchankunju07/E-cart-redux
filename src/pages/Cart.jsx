...
import { decrementQuantity, incerementQuantity} from '../redux/slices/cartSlice'
   ...
   userCart?.length>0?
    ...
    <div className="col-span-1">
      <div className="border rounded shadow p-5">
        ...
        <hr />
        <button onClick={checkout} className="bg-green-600 rounded p-2 w-full text-white mt-5 ">CHECK OUT</button>
      </div>
    </div>
    </div>
    </>
